      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <p ref="heroDescription">
            ...
            I specialize in React, Node.js, and modern web technologies to build scalable applications.
          </p>
          
          <div class="hero-buttons" ref="heroButtons">
            <a href="#projects" class="btn-primary" @click="scrollTo('projects')">View My Work</a>
            <a href="#contact" class="btn-secondary" @click="scrollTo('contact')">Get In Touch</a>
          </div>
...
onMounted(() => {
  ...
  tl.fromTo(heroDescription.value,
    { y: 50, opacity: 0 },
  ...
  // Buttons animation
  tl.fromTo(heroButtons.value.children,
    { y: 50, opacity: 0 },
  ...
  // Stats animation
  tl.fromTo(heroStats.value.children,
    { scale: 0, opacity: 0 },
...
.element-1 { top: 10%; left: 20%; }
.element-2 { top: 20%; right: 10%; }
.element-3 { top: 30%; left: 10%; }
.element-4 { top: 40%; right: 20%; }
.element-5 { bottom: 30%; left: 30%; }
.element-6 { bottom: 20%; right: 20%; }
.element-7 { bottom: 10%; right: 35%; }
